...
알고리즘 문제 해결 시 시간 복잡도와 공간 복잡도를 평가하는 데 필요한 참고 자료:

* **위치**: [COMPLEXITY_REFERENCE.md](./COMPLEXITY_REFERENCE.md)
* **내용**:
  - 시간 복잡도 평가 기준 (1초 = 10⁸ 연산 경험칙)
  - 공간 복잡도 평가 기준 (자료형별 메모리 사용량)
  - 자료구조별 시간/공간 복잡도
  - 알고리즘별 시간/공간 복잡도
  - 복잡도 평가 사고 과정

각 문제의 `2.algorithm.md`에서 시간/공간 복잡도를 평가할 때 이 참고 자료를 활용합니다.